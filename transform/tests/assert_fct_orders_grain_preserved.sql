/*
    ...
    a closed [valid_from, valid_to] interval would cause on the tied
    (customer, timestamp) pairs -- count in docs/figures.json) and on a
    DROP-OUT (an order falling in a gap between validity
