...
The dbt docs site is generated by CI on every push to `main` (`dbt docs generate`, uploaded as a Pages artifact) but **is not published yet**: Pages has still to be enabled for this repository. `make docs` builds and serves it locally in the meantime.
