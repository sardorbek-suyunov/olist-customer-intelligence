...
| The README reports the test count | A number typed by hand, once, from a report about the data. The README said 68, dbt reports 55, and CI's own comment said 67. | Three sources, three different answers, none of them reading from dbt. |
